...
class UnregisterActivity : AppCompatActivity() {
    ...
    fun initializeComponents() {
        val TextExplain1 = findViewById<TextView>(R.id.text_ex1)
        val TextExplain2 = findViewById<TextView>(R.id.text_ex2)
        val TextExplain3 = findViewById<TextView>(R.id.text_ex3)
        val TextExplain4 = findViewById<TextView>(R.id.text_ex4)
        val inputEditPassword = findViewById<EditText>(R.id.editTextPassword)
        val buttonChange = findViewById<Button>(R.id.buttonUnregister)
